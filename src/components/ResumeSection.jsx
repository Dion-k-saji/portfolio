...
function ResumeSection({firstName}) {
		...
		return (
				<section className=" bg-accent-bg py-12 text-accent-fg text-4xl/8 font-black flex flex-col items-center tracking-tighter relative overflow-hidden">
						...
						<a 
							href="/resume.pdf"
							className="absolute"
							download={`${firstName}'s_resume.pdf`}
						>
